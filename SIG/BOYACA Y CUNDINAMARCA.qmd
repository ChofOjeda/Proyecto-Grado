...
<qgis version="3.44.3-Solothurn">
  <identifier>Dep_Colombia</identifier>
  <parentidentifier></parentidentifier>
  <language>SPA</language>
  <type>dataset</type>
  <title>Dep_Colombia</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link format="" mimeType="" url="file://" description="" type="Local Area Network" name="Personal GeoDatabase Feature Class" size=""/>
  </links>
  <dates/>
  <fees></fees>
